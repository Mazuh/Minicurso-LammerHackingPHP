<h1>Minicurso "Básico de hacking para proteger sistemas em PHP"</h1>
...
<h2>The Hackbook</h2>
<p>É um sistema simplório de blog, muito de longe lembrando uma mescla das maiores redes sociais da atualidade, em que usuários podem realizar login, criar suas próprias publicações, escrever comentários e seguir. Foi feito com conhecimentos de Nível Técnico em Informática e possui diversas fraquezas a serem exploradas e cobertas pelos ouvintes do minicurso.</p>
<p>Foi licensiado com a <a href="LICENSE.md">MIT License (MIT)</a>.</p>
